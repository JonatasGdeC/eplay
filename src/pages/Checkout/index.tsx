              ...
              <S.Row>
                <S.InputGroup>
                  ...
                  <input
                    ...
                    className={checkInputIsError('fullName') ? 'error' : ''}
                  />
                </S.InputGroup>
                <S.InputGroup>
                  ...
                  <input
                    ...
                    onChange={form.handleChange}
                    onBlur={form.handleBlur}
                    className={checkInputIsError('email') ? 'error' : ''}
                  />
                </S.InputGroup>
                <S.InputGroup>
                  ...
                  <input
                    ...
                    onChange={form.handleChange}
                    onBlur={form.handleBlur}
                    className={checkInputIsError('cpf') ? 'error' : ''}
                  />
                </S.InputGroup>
              </S.Row>
              ...
              <S.Row>
                <S.InputGroup>
                  ...
                  <input
                    ...
                    onBlur={form.handleBlur}
                    className={
                      checkInputIsError('deliveryEmail') ? 'error' : ''
                    }
                  />
                </S.InputGroup>
                <S.InputGroup>
                  ...
                  <input
                    ...
                    onBlur={form.handleBlur}
                    className={
                      checkInputIsError('confirmDeliveryEmail') ? 'error' : ''
                    }
                  />
                </S.InputGroup>
              </S.Row>
                    ...
                    <S.Row>
                      <S.InputGroup>
                        ...
                        <input
                          ...
                          onBlur={form.handleBlur}
                          className={
                            checkInputIsError('cardOwner') ? 'error' : ''
                          }
                        />
                      </S.InputGroup>
                      <S.InputGroup>
                        ...
                        <input
                          ...
                          onBlur={form.handleBlur}
                          className={
                            checkInputIsError('cpfCardOwner') ? 'error' : ''
                          }
                        />
                      </S.InputGroup>
                    </S.Row>
                    <S.Row marginTop="24px">
                      <S.InputGroup>
                        ...
                        <input
                          ...
                          onBlur={form.handleBlur}
                          className={
                            checkInputIsError('cardDisplayName') ? 'error' : ''
                          }
                        />
                      </S.InputGroup>
                      <S.InputGroup>
                        ...
                        <input
                          ...
                          onBlur={form.handleBlur}
                          className={
                            checkInputIsError('cardNumber') ? 'error' : ''
                          }
                        />
                      </S.InputGroup>
                      <S.InputGroup maxWidth="123px">
                        ...
                        <input
                          ...
                          onBlur={form.handleBlur}
                          className={
                            checkInputIsError('expireMonth') ? 'error' : ''
                          }
                        />
                      </S.InputGroup>
                      <S.InputGroup maxWidth="123px">
                        ...
                        <input
                          ...
                          onBlur={form.handleBlur}
                          className={
                            checkInputIsError('expireYear') ? 'error' : ''
                          }
                        />
                      </S.InputGroup>
                      <S.InputGroup maxWidth="48px">
                        ...
                        <input
                          ...
                          onBlur={form.handleBlur}
                          className={
                            checkInputIsError('cardCode') ? 'error' : ''
                          }
                        />
                      </S.InputGroup>
                    </S.Row>
                    <S.Row marginTop="24px">
                      <S.InputGroup maxWidth="150px">
                        ...
                        <select
                          ...
                          onBlur={form.handleBlur}
                          className={
                            checkInputIsError('installments') ? 'error' : ''
                          }
                        >
